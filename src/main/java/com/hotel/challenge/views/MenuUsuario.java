...
public class MenuUsuario extends JFrame implements MouseInterface {
    ...
    public MenuUsuario() {
        ...
        header.addMouseMotionListener(new MouseMotionAdapter() {
            ...
            public void mouseDragged(MouseEvent e) {
                MouseUtil.dragged(MenuUsuario.this, e);
            }
        });
        header.addMouseListener(new MouseAdapter() {
            @Override
            public void mousePressed(MouseEvent e) {
                MouseUtil.pressed(MenuUsuario.this, e);
            }
        });
        ...
        panelFecha.setBounds(256, 84, 688, 212);
        ...
        JLabel lblNewJLabel = new JLabel("Bienvenido");
        lblNewJLabel.setFont(new Font("Roboto", Font.BOLD, 24));
        lblNewJLabel.setBounds(302, 234, 147, 46);
